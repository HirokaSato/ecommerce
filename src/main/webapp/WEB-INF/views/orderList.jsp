...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-offset-2 col-xs-8">
				<div class="form-group text-center">
					<span id="total-price"> 消費税：<fmt:formatNumber value="${tax}"
							pattern="###,###" />円
					</span><br> <span id="total-price">ご注文金額合計：<fmt:formatNumber
							value="${taxIncludedAmount}" pattern="###,###" />円(税込)
					</span>
				</div>
			</div>
		</div>
		...
		<form:form modelAttribute="orderForm"
			action="${pageContext.request.contextPath}/doOrderController/order">
						...
						<tbody>
							<tr>
								...
								<td><form:errors path="name" cssStyle="color:red"
										element="div" /> <form:input path="name" value="${user.name}" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td><form:errors path="email" cssStyle="color:red"
										element="div" /> <form:input path="email"
										value="${user.email}" /></td>
							</tr>
							<tr>
								<td>
									<div class="text-center">郵便番号(ハイフンなし)</div>
								</td>
								<td><form:errors path="zipcode" cssStyle="color:red"
										element="div" />
									<div class="errors">
										<c:out value="${errors3}" />
									</div> <form:input path="zipcode" id="zipcode" /> &nbsp;&nbsp;<input
									type="button" id="searchZipcode" value="住所検索"></input></td>
							</tr>
							<tr>
								<td>
									<div class="text-center">住所</div>
								</td>
								<td><form:errors path="address" cssStyle="color:red"
										element="div" /> <form:input path="address" id="address"
										value="${user.address}" /> &nbsp;&nbsp;<input type="button"
									id="searchAddress" value="郵便番号検索"></input><br>
									(例：〇〇県〇〇市〇〇→検索可)</td>
							</tr>
							<tr>
								<td>
								...
								<td><form:errors path="telNumber" cssStyle="color:red"
										element="div" />
									<div class="errors">
										<c:out value="${errors2}" />
									</div> <form:input path="telNumber" value="${user.telephone}" /></td>
							</tr>
							<tr>
								<td>
									<div class="text-center">希望配達日時</div>
								</td>
								<td>
										...
										<div class="row">
											<div class="col-sm-12">
												<label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="10:00:00" /> 10時
												</label> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="11:00:00" /> 11時
												</label> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="12:00:00" /> 12時
												</label><br> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="13:00:00" /> 13時
												</label> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="14:00:00" /> 14時
												</label> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="15:00:00" /> 15時
												</label><br> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="16:00:00" /> 16時
												</label> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="17:00:00" /> 17時
												</label> <label class="radio-inline"> <form:radiobutton
														path="deliveryTime" value="18:00:00" /> 18時
												</label><br>
											</div>
										</div>
									</div>
							...
							<tr>
								...
								<td align="center">
									<div class="row">
										<div class="col-sm-12">
											<label class="radio-inline"> <form:radiobutton
													path="paymentMethod" value="2" />
											</label><br>
											<br>
										</div>
									</div> <%---<script src="https://checkout.webpay.jp/v3/" class="webpay-button" data-key="test_public_87Aa3Pe1r1XffA3dwB8TH690" data-lang="ja" data-partial="true"/>--%>
								</td>
							</tr>
						</tbody>
					</table>
			...
			<div class="row">
				<div class="col-xs-offset-4 col-xs-4">
					...
					<br> <a href="${pageContext.request.contextPath}/top"> <input
						class="form-control btn btn-warning btn-block" type="button"
						value="商品一覧へ戻る"
