...
public class DoOrderController {
	...
	public String insert(@Validated OrderForm form, BindingResult result, @AuthenticationPrincipal LoginUser loginUser,
		...
		try {
			...
			LocalDateTime deliveryDateTime = LocalDateTime.of(integerDeliveryDateList[0], integerDeliveryDateList[1],
					integerDeliveryDateList[2], integerDeliveryTimeList[0], integerDeliveryTimeList[1],
					integerDeliveryTimeList[2]);
